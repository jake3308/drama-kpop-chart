...
try:
    with connection.cursor() as cursor:
        # drama_ranking 테이블에서 특정 드라마의 previous_weekly_search_volumes 가져오기
        cursor.execute("SELECT korean_name, previous_weekly_search_volumes FROM drama_ranking WHERE id = %s", (2,))
