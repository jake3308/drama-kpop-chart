...
def update_weekly_search_volume():
    # MySQL 연결 설정
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.execute("SELECT id, korean_name, previous_weekly_search_volumes FROM drama_ranking")
            ...
            for drama in dramas:
                ...
                if response_normal.status_code == 200 and response_no_space.status_code == 200:
                    ...
                    # 두 검색량을 합산
                    current_weekly_search_volume = search_volume_normal + search_volume_no_space
                    print(f"'{korean_name}'에 대한 현재 주간 검색 결과 수: {current_weekly_search_volume}")
                    ...
                    # 주간 검색량 계산 (current_weekly_search_volume - previous_weekly_search_volume)
                    ...
                    print(f"'{korean_name}'에 대한 주간 검색량: {weekly_search_volume}")
                    ...
                    cursor.execute("""
                        ...
                        WHERE id = %s
                    """, (previous_volumes_json, current_weekly_search_volume, weekly_search_volume, drama_id))
